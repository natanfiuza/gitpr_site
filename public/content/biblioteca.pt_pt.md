...
Usado pela sua total compatibilidade com a **API DeepSeek** e **Ollama** (modelos locais). Permite a arquitetura multi-fornecedor sem dependência de vendor.
...
Fornece **encriptação simétrica Fernet** para armazenar chaves de API com segurança em disco. A sua `GEMINI_API_KEY` nunca é guardada em texto simples.

### [Python-dotenv](https://pypi.org/project/python-dotenv/)
Gere variáveis de ambiente no ficheiro de configuração `~/.gitpr/.env`, mantendo organizadas as definições de fornecedores e preferências de idioma.
...
Framework de testes moderno com saída colorida e legível na consola. Usado para testes unitários e de integração em todos os módulos.
...
Python foi escolhido pelo seu **ciclo de desenvolvimento rápido**, **compatibilidade multiplataforma** (Windows, macOS, Linux), ecossistema rico de bibliotecas de IA/LLM e a capacidade de compilar num único binário sem dependências com **PyInstaller**.

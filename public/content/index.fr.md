...
```bash
# Téléchargez depuis GitHub Releases et ajoutez à votre PATH, puis :
gitpr
```

Lors de la première exécution, un assistant vous guidera dans la configuration — entrez simplement votre clé API et vous êtes prêt.

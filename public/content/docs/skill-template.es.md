...
La pantalla `gitpr config` tiene una sección **Skills** que lista estos mismos archivos y abre cada uno en un editor, para ajustar una regla sin salir del terminal ([Pantalla de Configuración Interactiva](/docs/config-tui?lang=es), §1.7).

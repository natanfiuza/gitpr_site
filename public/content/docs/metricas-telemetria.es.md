...
- [Integración MCP](/docs/mcp-integration?lang=es) — Configuración del servidor MCP
- [MCP Prompts](/docs/mcp-prompts?lang=es) — Plantillas de mensaje predefinidas
- [MCP Tool Annotations](/docs/mcp-annotations?lang=es) — Sugerencias de integración con IDEs

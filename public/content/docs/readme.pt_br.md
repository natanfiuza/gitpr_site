...
> **Configuração Guiada:** Configuração guiada que baixa templates de skills, instala Git Hooks, configura o MCP para seus editores e verifica a chave de API do seu provedor de IA.  

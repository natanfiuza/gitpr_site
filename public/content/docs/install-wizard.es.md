...
📚 Ver también: [Sistema de Skills y Plantillas](/docs/skill-template?lang=es)
...
📚 Ver también: [Git Hooks Locales](/docs/git-hooks-locais?lang=es)
...
📚 Ver también: [Integración MCP](/docs/mcp-integration?lang=es)
...
📚 Ver también: [Proveedores de IA](/docs/providers-ia?lang=es)

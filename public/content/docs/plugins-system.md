...
- [Custom Linter Rules](/docs/linter-regras-customizadas) — How to write `.gitpr.linter.yml` rules
- [Skills and Templates](/docs/skill-template) — Project-local AI prompts and rules

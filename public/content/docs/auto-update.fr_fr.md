...
> **Note :** Consultez également la [documentation principale (README.md)](docs/readme?lang=fr_fr) pour des informations sur l'installation et la configuration initiale.

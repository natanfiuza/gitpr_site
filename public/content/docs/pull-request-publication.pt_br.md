...
> **Nota — Assinatura de coautoria:** o trailer `Co-Authored-By: Gitpr-cli <gitpr@natanfiuza.dev.br>` é injetado em momentos diferentes conforme o fluxo:
>
...
> - **`--no-edit` (console):** o trailer é anexado na geração e fica visível na prévia antes da confirmação.
...
- Consulte o guia completo em [github-pat-integration.md](/docs/github-pat-integration?lang=pt_br)
...
> **Nota:** Consulte também a [documentação principal (README.md)](/docs/readme?lang=pt_br) para uma visão geral de todos os recursos do GitPR e o [guia de Descrição de PR](/docs/pr-descricao-padrao?lang=pt_br) para o fluxo padrão de geração de PR.

...
- [Intégration MCP](/docs/mcp-integration?lang=fr) — Configuration du serveur MCP
- [MCP Prompts](/docs/mcp-prompts?lang=fr) — Modèles de message prédéfinis
- [MCP Tool Annotations](/docs/mcp-annotations?lang=fr) — Conseils d'intégration avec les IDEs

...
📚 Ver também: [Sistema de Skills e Templates](docs/skill-template?lang=pt_pt)
...
📚 Ver também: [Git Hooks Locais](docs/git-hooks-locais?lang=pt_pt)
...
📚 Ver também: [Integração MCP](docs/mcp-integration?lang=pt_pt)
...
📚 Ver também: [Fornecedores de IA](docs/providers-ia?lang=pt_pt)

...
> **Personalização:** Você pode customizar o template usado pela IA através do arquivo `.gitpr.issue.md` em `.gitpr/skill/` (baixe com `gitpr -s`).
...
> **Nota:** Consulte também a [documentação principal (README.md)](/docs/readme?lang=pt_br) para visão geral de todas as funcionalidades do GitPR.

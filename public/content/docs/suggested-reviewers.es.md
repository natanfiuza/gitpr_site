...
Registro de decisión de arquitectura y vocabulario canónico: [ADR-002 Sugerencia de Revisores](https://github.com/gitpr-cli/gitpr.git/blob/main/docs/plans/ADR-002-reviewer-suggestion.md) y [Glosario de Sugerencia de Revisores](https://github.com/gitpr-cli/gitpr.git/blob/main/docs/plans/glossary-reviewer-suggestion.md).

> **Nota:** Consulte también la [documentación de publicación de pull requests](/docs/pull-request-publication?lang=es) para conocer el flujo completo de publicación, sus modos y sus flags.

...
Publishing targets the forge configured through the SCM settings (`gitpr --init` or `GITPR_SCM_PROVIDER`). See the [Multi-Forge SCM documentation](/docs/scm-multiforge) for the provider setup.

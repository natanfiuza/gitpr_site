...
Registre de décision d'architecture et vocabulaire canonique : [ADR-002 Suggestion de Relecteurs](https://github.com/gitpr-cli/gitpr.git/blob/main/docs/plans/ADR-002-reviewer-suggestion.md) et [Glossaire de la Suggestion de Relecteurs](https://github.com/gitpr-cli/gitpr.git/blob/main/docs/plans/glossary-reviewer-suggestion.md).

> **Remarque :** Voir aussi la [documentation de publication des pull requests](/docs/pull-request-publication?lang=fr) pour le flux complet de publication, ses modes et ses flags.

# **🚀 Relatório de Estado do Projeto: GitPR CLI — v0.0.27 (2026-07-19)**
...
* **Testes:** Pytest + unittest.mock (7 ficheiros de teste, 130+ cenários).
...
* **Routing de Comandos:** Gere todas as flags (`--commit`, `--review`, `--fullreview`, `--linter`, `--skill`, `--issue`, `--blame`, `--chat`, `--lang`, `--provider`, `--pre-save`).
...
* **130+ ficheiros** traduzidos/versionados.
...
|---|---|---|
| **Fornecedores IA** | Gemini + DeepSeek | Gemini + DeepSeek + **Ollama (local)** |
...
| **Testes** | 1 ficheiro | **7 ficheiros (130+ cenários)** |
...
| **Chat Memory** | — | **Persistência por ramo** |
